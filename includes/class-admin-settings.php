...
class Admin_Settings {
	...
	private static function strings() {
		return array(
			...
			'supportTitle'     => __( 'Need help?', 'responsive-visibility' ),
			'supportIntro'     => __( 'Support and setup help from the plugin author.', 'responsive-visibility' ),
			'supportRole'      => __( 'WordPress & Full-Stack Engineer', 'responsive-visibility' ),
			'supportBio'       => __( '8+ years of experience in WordPress and full-stack development. Founder of wowDevs, he builds advanced software solutions and AI-driven workflows while supporting the tech community.', 'responsive-visibility' ),
			'supportName'      => __( 'Shahidul Islam', 'responsive-visibility' ),
			'supportEmail'     => __( 'support@wowdevs.com', 'responsive-visibility' ),
			'supportWhatsApp'  => __( '+8801304999933', 'responsive-visibility' ),
			'supportWebsite'   => __( 'wowdevs.com', 'responsive-visibility' ),
